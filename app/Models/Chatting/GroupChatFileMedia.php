...
class GroupChatFileMedia extends Model
{
    ...
    /**
     * Get the group chatting that owns the file.
     */
    public function group_chatting()
    {
        return $this->belongsTo(GroupChatting::class, 'group_chatting_id');
    }
