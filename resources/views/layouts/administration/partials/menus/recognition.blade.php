    ...
    <ul class="menu-sub">
        @can('Recognition Read')
            <li class="menu-item {{ request()->is('recognition/analytics*') ? 'active' : '' }}">
                <a href="{{ route('administration.recognition.analytics') }}" class="menu-link">{{ __('Analytics') }}</a>
            </li>
        @endcan
        @can('Recognition Read')
            <li class="menu-item {{ request()->is('recognition/leaderboard*') ? 'active' : '' }}">
                <a href="{{ route('administration.recognition.leaderboard') }}" class="menu-link">{{ __('Leaderboard') }}</a>
            </li>
        @endcan
        @canany(['Recognition Everything'])
            <li class="menu-item {{ request()->is('recognition/all*') ? 'active' : '' }}">
                <a href="{{ route('administration.recognition.index') }}" class="menu-link">{{ __('All Recognitions') }}</a>
            </li>
        @endcanany
        @can('Recognition Read')
            <li class="menu-item {{ request()->is('recognition/my*') ? 'active' : '' }}">
                <a href="{{ route('administration.recognition.my') }}" class="menu-link">{{ __('My Recognitions') }}</a>
            </li>
        @endcan
        @can('Recognition Create')
            <li class="menu-item {{ request()->is('recognition/create*') ? 'active' : '' }}">
                <a href="{{ route('administration.recognition.create') }}" class="menu-link">{{ __('New Recognition') }}</a>
            </li>
        @endcan
    </ul>
</li>
