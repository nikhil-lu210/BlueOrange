                        ...
                        @canany (['Quiz Everything', 'Quiz Create'])
                            <li class="menu-item {{ request()->is('quiz/test/create*') ? 'active' : '' }}">
                                <a href="{{ route('administration.quiz.test.create') }}" class="menu-link">
                                    <div data-i18n="Assign Test">{{ ___('Assign Test') }}</div>
                                </a>
                            </li>
                        @endcanany
                    </ul>
