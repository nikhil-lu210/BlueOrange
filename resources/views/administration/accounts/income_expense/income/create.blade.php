                ...
                <form id="workUpdateForm" action="{{ route('administration.accounts.income_expense.income.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="row justify-content-center">
                        ...
                        <div class="mb-3 col-md-9">
                            ...
                            <input type="text" name="source" class="form-control" placeholder="Ex: Sold Old Gadgets" required/>
                            @error('source')
                                <span class="text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row">
                        <div class="mb-3 col-md-12">
                            ...
                            <div name="description" id="workUpdateEditor">{!! old('description') !!}</div>
                            <textarea class="d-none" name="description" id="workUpdateInput">{{ old('description') }}</textarea>
                            @error('description')
...
@section('custom_script')
    ...
    <script>
        $(document).ready(function () {
            ...
            @if(old('description'))
                workUpdateEditor.root.innerHTML = {!! json_encode(old('description')) !!};
            @endif
