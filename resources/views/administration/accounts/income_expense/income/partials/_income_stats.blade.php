                ...
                <div class="d-flex justify-content-between flex-wrap gap-3">
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="content-right">
                            <h5 class="text-success mb-0">{{ format_currency( $total['overall_income'], 'BDT') }}</h5>
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="content-right">
                            <h5 class="text-warning mb-0">{{ format_currency( $total['last_month_income'], 'BDT') }}</h5>
                    ...
                    <div class="d-flex align-items-center gap-3">
                        ...
                        <div class="content-right">
                            <h5 class="text-primary mb-0">{{ format_currency( $total['current_month_income'], 'BDT') }}</h5>
