                ...
                <div class="card-body">
                    <div class="row">
                        <div class="mb-3 col-md-3">
                            <label for="team_leader_id" class="form-label">{{ ___('Select Team Leader') }}</label>
                            <select name="team_leader_id" id="team_leader_id" class="select2 form-select @error('team_leader_id') is-invalid @enderror" data-allow-clear="true">
                                <option value="" {{ is_null(request()->team_leader_id) ? 'selected' : '' }}>{{ ___('Select Team Leader') }}</option>
