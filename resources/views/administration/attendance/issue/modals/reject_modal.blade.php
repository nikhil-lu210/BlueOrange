        ...
        <div class="modal-content p-3">
            ...
            <div class="modal-body">
                <div class="text-center mb-4">
                    <h3 class="role-title mb-2">{{ ___('Reject Attendance Issue') }}</h3>
                    <p class="text-muted">{{ ___('Reject the Attendance Issue of') }} <b class="text-primary">{{ $issue->user->alias_name }}</b></p>
                </div>
                <!-- Status form -->
                <form method="post" action="{{ route('administration.attendance.issue.update', ['issue' => $issue, 'status' => 'Rejected']) }}" enctype="multipart/form-data" class="row g-3" autocomplete="off">
                    ...
                    <div class="col-md-12 mb-3">
                        <label class="form-label">{{ ___('Rejection Reason') }} <strong class="text-danger">*</strong></label>
