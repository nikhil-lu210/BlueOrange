                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="mb-3 col-md-6">
                            <label for="clock_in" class="form-label">{{ ___('Clock In') }} <strong class="text-danger">*</strong></label>
                        ...
                        <div class="mb-3 col-md-6">
                            <label for="clock_out" class="form-label">{{ ___('Clock Out') }}</label>
