<form action="{{ route('administration.certificate.generate') }}" method="GET" autocomplete="off">
    ...
    <div class="card mb-4">
        <div class="card-header header-elements">
            <h5 class="mb-0">Generate Certificate</h5>
        </div>
        <div class="card-body">
            <div class="row">
                ...
                {{-- Leave Starts From will be visible and required only for Experience Letter --}}
                <div class="mb-3 col-md-12">
                ...
                {{-- Leave Ends On will be visible but not required only for Experience Letter --}}
                <div class="mb-3 col-md-12">
