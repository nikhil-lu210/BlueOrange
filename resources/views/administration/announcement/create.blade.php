...
@section('page_title', __('Create New Announcement'))
...
@section('page_name')
    <b class="text-uppercase">{{ __('Create New Announcement') }}</b>
@endsection

@section('breadcrumb')
    <li class="breadcrumb-item">{{ __('Announcements') }}</li>
    <li class="breadcrumb-item active">{{ __('Create New Announcement') }}</li>
@endsection
            ...
            <div class="card-body">
                <form id="announcementForm" action="{{ route('administration.announcement.store') }}" method="post" enctype="multipart/form-data" autocomplete="off">
                    ...
                    <div class="mt-2 float-end">
                        <a href="{{ route('administration.announcement.create') }}" class="btn btn-outline-danger me-2 confirm-danger">Reset Form</a>
