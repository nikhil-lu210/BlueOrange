...
@section('page_title', __('Permission Groups'))
...
@section('page_name')
    <b class="text-uppercase">{{ __('Permission Groups') }}</b>
@endsection
...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item text-capitalize active">{{ __('Permission Groups') }}</li>
@endsection


@section('breadcrumb_buttons')
    <a href="{{ route('administration.settings.permission.group.create') }}" class="btn btn-outline-dark btn-outline-custom fw-bolder">
    ...
    <div class="col-lg-12">
        <div class="card m-b-30">
            <div class="card-header">
                <h5 class="card-title">{{ __('All Permission Groups') }}</h5>
            </div>
            <div class="card-body">
                    ...
                    <table id="default-datatable" class="display table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>sdfsdf</td>
                                <td>
                                    <small class="badge badge-dark">asd</small>
                                    <small class="badge badge-dark">asd</small>
                                    <small class="badge badge-dark">asd</small>
                                </td>
                                <td>
