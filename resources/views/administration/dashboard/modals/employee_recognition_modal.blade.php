        ...
        <div class="modal-content p-3 p-md-5">
            ...
            <div class="modal-body">
                <div class="text-center mb-4">
                    <h3 class="role-title text-capitalize mb-2">{{ __('Submit Recognition') }}</h3>
                ...
                <form method="post" action="{{ route('administration.recognition.store') }}" class="row g-3" autocomplete="off">
                    ...
                    <div class="mb-3 col-md-12">
                        <label for="category" class="form-label">{{ __('Recognition Category') }} <strong class="text-danger">*</strong></label>
                    ...
                    <div class="mb-3 col-md-12">
                        <label for="total_mark" class="form-label">
                            ...
                            <sup>{{ __('(Between ' . config('recognition.marks.min') . ' to ' . config('recognition.marks.max') . ')') }}</sup>
                        </label>
                    ...
                    <div class="col-12 text-center">
                        <button type="reset" class="btn btn-label-dark" data-bs-dismiss="modal" aria-label="Close">{{ __('Cancel') }}</button>
                        <button type="submit" class="btn btn-primary me-sm-3 me-1">{{ __('Submit Recognition') }}</button>
                    </div>
                </form>
            </div>
        </div>
