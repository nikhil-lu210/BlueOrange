...
@section('email_title')
    <span style="text-align: center;">Birthday Of <b>{{ $data->user->name }}</b> ({{ $data->alias_name }})</span>
@endsection
...
<div>
    ...
    <br><br>
    It's <b>{{ $data->user->name }}</b> ({{ $data->alias_name }}). Yes, Today is <b>{{ $data->user->name }}</b> ({{ $data->alias_name }}) Happy Birthday. You can wish him/her a warm birthday wish.
    <br><br>
