...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}" class="light-style layout-navbar-fixed layout-menu-fixed layout-compact" dir="ltr" data-theme="theme-default" data-assets-path="/assets/" data-template="">
    <head>
        ...
        <title>{{ config('app.name') }} || Computer Restricted</title>
        <!-- Favicon -->
    ...
    <body>
        ...
        <div class="container">
            <div class="misc-wrapper">
                ...
                <h2 class="mb-1 mx-2">Oops! 😖 You are trying to access the site by Computer Device.</h2>
                <p class="mb-4 mx-2">{{ __('The site is computer restricted. You cannot access the site by computer. Please use another device.') }}</p>
                ...
                <div class="mt-0">
                    <img src="{{ asset('assets/img/illustrations/page-misc-under-maintenance.png') }}" alt="page-misc-not-authorized" width="450" class="img-fluid" />
                </div>
            </div>
        </div>
        <!-- /Not Authorized -->
